...
#if SENSOR_FLIP
	#define	TARGET_Y  				0x2a//0x28	//Luminace
...
**************************************************************************/	
	...
	//========================================================================= 
	#define	DAYLIGHT_SAT_U_SCALE  	0x2a	//Default:0x20 	// blud
	#define	DAYLIGHT_SAT_V_SCALE  	0x2a	//Default:0x20	// red
#else

	#define	TARGET_Y  				0x28//0x28	//Luminace
	#define TARGET_Y_LOW			(TARGET_Y>>2)	//TARGET_Y_LOW = TARGET_Y/4  
	#define MAX_ANALOG_GAIN			7.2		//3 ~ 5
